...
fn main() {
    ...
    App::new()
        ...
        .add_plugins(editor::EditorCorePlugin)
        ...
        .add_plugins(track::TrackEditorPlugin)
        .add_plugins(train::TrainPlugin)
        .add_plugins(train::TrainEditorPlugin)
        .add_plugins(marker::MarkerPlugin)
        .add_plugins(marker::MarkerEditorPlugin)
        ...
        .add_plugins(switch::SwitchEditorPlugin)
        ...
        .add_plugins(schedule::ScheduleEditorPlugin)
        ...
        .add_plugins(route_modular::ModularRouteEditorPlugin)
